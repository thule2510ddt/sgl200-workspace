...
Generated source and branch maps:

- [`architecture/source-code-map.md`](architecture/source-code-map.md) - source files generated by AI and their architecture responsibilities.
- [`architecture/branch-map.md`](architecture/branch-map.md) - branch roles, feature branch dependencies, and recommended merge order.
